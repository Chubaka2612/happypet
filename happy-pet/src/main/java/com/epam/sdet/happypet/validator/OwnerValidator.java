...
public class OwnerValidator extends AbstractValidator implements Validator {
    ...
    private static final String NAME_VALIDATION_ERROR = "Owner name is not valid";
    private static final String PHONE_VALIDATION_ERROR = "Owner phone number is not valid";
